	...
	<div class="row">
		<div class="col-9">
			<div class="card card-secondary card-outline">
				<div class="card-header">
					...
					<div class="float-left">
						...
						<button type="button" class="btn btn-md btn-outline-success"
							onclick="location.href='./storageList.jsp'">임시저장목록</button>
					</div>
					<div class="float-right">
						<div class="btn-group float-right">
							<button type="button" class="btn btn-md btn-secondary"
								onclick="location.href='./list.jsp'">나의 업무보고</button>
				...
				<div class="card-body">
					<div class="input-group float-right col-6">
			...
			<div class="card card-outline card-secondary">
				...
				<div class="card-body p-2">
					<div class="card card-outline card-secondary collapsed-card">
						<div class="card-header">
							<h3 class="card-title">
								<a href="./registForm.jsp">일일보고 마감기한</a>
							</h3>
					...
					<div class="card card-outline card-success collapsed-card">
						<div class="card-header">
							<h3 class="card-title">
								<a href="./registForm.jsp">주간보고 마감기한</a>
							</h3>
					...
					<div class="card card-outline card-danger collapsed-card">
						<div class="card-header">
							<h3 class="card-title">
								<a href="./registForm.jsp">월간보고 마감기한</a>
							</h3>
