		...
		<div class="col-9 card card-secondary card-outline">
			...
			<div class="card-header">
				<div class="btn-group float-right">
					<button type="button" class="btn btn-md btn-outline-secondary" onclick="location.href='./list.jsp'">나의
						업무보고</button>
					<button type="button" class="btn btn-md btn-secondary"
						onclick="location.href='./getList.jsp'">받은 업무보고</button>
				</div>
			</div>
			<div class="card-body">
					...
					<div class="card">
						...
						<div class="card-header">
							...
							<div class="float-left">
								<div class="btn-group">
									<button type="submit" class="btn btn-md btn-primary mr-1"
		...
		<div class="col-3">
			<div class="card card-outline card-secondary">
				<div class="card-header pt-3 pb-3">
					<h3 class="card-title pt-2">미확인 보고서</h3>
				</div>
				<div class="card-body p-2">

					<div class="card card-outline card-secondary collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./detail.jsp">일일보고 이소망</a></h3>
						...
						<!-- /.card-header -->
						<div class="card-body">***가 되지 않음</div>
						<!-- /.card-body -->
					</div>
					<div class="card card-outline card-secondary collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./detail.jsp">일일보고 허리보</a></h3>
					...
					<div class="card card-outline card-success collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./detail.jsp">주간보고 허리보</a></h3>
					...
					<div class="card card-outline card-danger collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./detail.jsp">월간보고 허리보</a></h3>
