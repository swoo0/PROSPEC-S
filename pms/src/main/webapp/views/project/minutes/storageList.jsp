		...
		<div class="col-9 card card-secondary card-outline">
			...
			<div class="card-header">
				<div class="btn-group float-right">
					<button type="button" class="btn btn-md btn-secondary" onclick="location.href='./list.jsp'">나의
						업무보고</button>
						...
						<div class="card-body table-responsive p-0">
							<table class="table table-hover text-nowrap">
								...
								<tbody>
									<tr>
										<td>일일</td>
										<td><a href="./modify.jsp">이소망 일일 업무보고</a></td>
										<td>허리보</td>
			...
			<div class="card card-outline card-info">
				...
				<div class="card-body p-2">
					<div class="card card-outline card-secondary collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./registForm.jsp">일일보고 마감기한</a></h3>
					...
					<div class="card card-outline card-success collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./registForm.jsp">주간보고 마감기한</a></h3>
					...
					<div class="card card-outline card-danger collapsed-card">
						<div class="card-header">
							<h3 class="card-title"><a href="./registForm.jsp">월간보고 마감기한</a></h3>
